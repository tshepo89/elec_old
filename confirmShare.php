    ...
    <html class="no-js" lang="en">
        ...
        <body>
            <header class="fixed" style="background: #262626 !important;">
                ...
                <nav id="the-top-nav">
                    <ul>
                        ...
                        <li><a href="questions/">Sign In</a></li>
            ...
            <div class="reveal medium" id="the-signup-modal" data-reveal>
                <br/>
                <br/>
                <h4 class="text-center subheader">Confirm</h4>
                <hr class="dotted">
                <div class="row">
                    <h5 class="text-center subheader">Electricity will be shared with</h5>
                    <div class="large-12 columns large-centered">              
                        <form name="" data-abide novalidate action="">
                            ...
                            <label>
                                <b>Email Address</b>
                                <input type="email" required pattern="[a-zA-Z]+" placeholder="morailane@gmail.com" name="" value="tshepo.morailane@mukoni.co.za"/>
                                <span class="form-error">Enter a vailed email address.</span>
                            </label>
                            <label>
                                <b>Cellphone</b>
                                <input type="tel" required placeholder="0113443222" aria-describedby="exampleHelpText" required pattern="number" name="" value="0218811212" />
                                <span class="form-error">Invalid Cellphone number. Format required 0123556789</span>
                            </label>
                            <label>
                                <b>Residential Address</b>
                                <input type="text" style="height: 100px;" required placeholder="11 Rooivalk close" required pattern="[a-zA-Z]+" name="" value="'201 Cascade Terraces' <br>'Tyger Waterfront'"/>
                                <span class="form-error">Please enter your Address.</span>
                            </label>
                            <label>
                                <b>For Meter no</b>
                                <input type="tel" required placeholder="0113443222" aria-describedby="exampleHelpText" required pattern="number" name="" value="3000922311" />
                                <span class="form-error">Invalid Cellphone number. Format required 0123556789</span>
                            </label>
                            <label>
                                <b>Amount of Units</b>
                                <input type="tel" required placeholder="113" aria-describedby="exampleHelpText" required pattern="number" name="" value="303" />
                                <span class="form-error">Invalid Cellphone number. Format required 0123556789</span>
                            </label>
                            <p class="text-center ">by clicking "Generate token" you accept the <a>terms of use</a></p>
                            
                            <p><button class="button expanded" type="submit" value="Submit"><b>Generate Token<b></button>
                        </form>
                    </div>
                </div>
