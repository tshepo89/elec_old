    ...
    <html class="no-js" lang="en">
        ...
        <body>
            ...
            <div class="reveal medium" id="the-signup-modal" data-reveal>
                <br/>
                <br/>
                <h4 class="text-center subheader">SHARE ELECTRICITY</h4>
                <hr class="dotted">
                <div class="row">
                    <div class="large-12 columns large-centered">              
                        <form name="" data-abide novalidate action="">
                            ...
                            <label><b>Amount of of electricity units to share?<b>
                            <fieldset>
                                <input type="radio" name="pokemon" value="Red"  id="pokemonRed"><label for="pokemonRed">50 kW</label>
                                <input type="radio" name="pokemon" value="Blue" id="pokemonBlue"><label for="pokemonBlue">100 kW</label>
                                <input type="radio" name="pokemon" value="Yellow" id="pokemonYellow"><label for="pokemonYellow">150 kW</label>
                                <input type="radio" name="pokemon" value="Yellow" id="pokemonYellow"><label for="pokemonYellow">200 kW</label>
                                <span class="form-error">Select amount of electricity units to share with beneficiary.</span>
                            </fieldset>
                            ...
                            <label>
                                <b>Own amount</b>
                                <input type="text" required placeholder="0113443222" aria-describedby="exampleHelpText" required pattern="number" name=""/>
                                <span class="form-error">Specify the amount of units to share. e.g. "300" kW </span>
                            </label>
                              
                            <p><a href="beneficiary.html" class="button expanded" type="submit" value="Submit"><b>SUBMIT<b></a>
                        </form>
                    </div>
                </div>
