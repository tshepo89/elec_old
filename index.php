    ...
    <html class="no-js" lang="en">
        ...
        <body>
            ...
            <div class="reveal medium" id="the-signup-modal" data-reveal>
                <br/>
                <br/>
                <h4 class="text-center subheader">SIGN UP</h4>
                <hr class="dotted">
                <div class="row">
                    <div class="large-12 columns large-centered">              
                        <form name="" data-abide novalidate action="">
                            ...
                            <label>
                                <b>First Name</b>
                                <input type="text" required pattern="[a-zA-Z]+" placeholder="Tshepo" name=""/>
                                <span class="form-error">First Name required.</span>
                            </label>
                            <?php echo "test"; ?>
                            <label>
                                <b>Last Name</b>
                                <input type="text" required pattern="[a-zA-Z]+" placeholder="Morailane" name=""/>
                                <span class="form-error">Last Name required</span>
                            </label>
                            <label>
                                <b>Email Address</b>
                                <input type="email" required pattern="[a-zA-Z]+" placeholder="morailane@gmail.com" name=""/>
                                <span class="form-error">Enter a vailed email address.</span>
                            </label>
                            <label>
                                <b>Cellphone</b>
                                <input type="tel" required placeholder="0113443222" aria-describedby="exampleHelpText" required pattern="number" name=""/>
                                <span class="form-error">Invalid Cellphone number. Format required 0123556789</span>
                            </label>
                            <label>
                                <b>Residential Address</b>
                                <input type="text" style="height: 100px;" required placeholder="11 Rooivalk close" required pattern="[a-zA-Z]+" name=""/>
                                <span class="form-error">Please enter your Address.</span>
                            </label>
                            <label>
                                <b>Password</b>
                                <input type="password" id="password" required name="" aria-describedby="exampleHelpText" required >
                                <span class="form-error">Password required!</span>
                            </label>
                            <label>
                                <b>Re-Enter Password</b>
                                <input type="password" name="" title="Must con"aria-describedby="exampleHelpText2" required pattern="alpha_numeric" data-equalto="password">
                                <span class="form-error">Hey, passwords are supposed to match!</span>
                            </label>
                            <p class="text-center ">by clicking "sign up" you accept the <a>terms of use</a></p>
                            
                            <p><button class="button expanded" type="submit" value="Submit"><b>SIGN UP<b></button>
                        </form>
                    </div>
                </div>
