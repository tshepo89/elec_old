    ...
    <html class="no-js" lang="en">
        ...
        <body>
            ...
            <div  class="reveal medium" id="the-signup-modal" data-reveal >
                <br/>
                <br/>
                <h4 class="text-center subheader">REQUEST ELECTRICITY</h4>
                <hr class="dotted">
                <div class="row">
                    <div class="large-12 columns large-centered">              
                        <form name="" data-abide novalidate action="">
                            ...
                            <label><b>Amount of of electricity units required?<b>
                            <fieldset>
                                ...
                                <span class="form-error">Select amount of electricity units required</span>
                            </fieldset>
                            ...
                            <label>
                                ...
                                <span class="form-error">Specify the amount of units you require. e.g. "300" kW </span>
                            </label>
                              
                            <p><a class="button expanded" href="requestOwner.html" type="submit" value="Submit"><b>REQUEST<b></a>
                        </form>
                    </div>
                </div>
